...
public class SMChatActivity extends AppCompatActivity {
   ...
   // APIService apiService;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!msg.equals("")){
                    ...
                    Toast.makeText(SMChatActivity.this, "You can't send empty message", Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
        ...
        reference = FirebaseDatabase.getInstance().getReference("Users").child("ResponsibleMan").child(userid);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    chatAdapter = new ChatAdapter(SMChatActivity.this, mchat, imageurl);
