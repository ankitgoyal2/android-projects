...
public class MyMachine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rMachineAdapter = new RMachineAdapter(getApplicationContext(), machineList);
        recyclerView_machine .setAdapter(rMachineAdapter);
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                ...
                machineReference.child(key).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        rMachineAdapter.notifyDataSetChanged();
                    }
